...
metric_defaults = EasyDict([(args.name, args) for args in [
    ...
    EasyDict(name='fid200k_full',     class_name='metrics.frechet_inception_distance.FID', max_reals=None, num_fakes=200000, minibatch_per_gpu=8, force_dataset_args=dict(shuffle=False, max_images=None, repeat=False, mirror_augment=False)),
    EasyDict(name='fid15k_full',     class_name='metrics.frechet_inception_distance.FID', max_reals=None, num_fakes=15000, minibatch_per_gpu=8, force_dataset_args=dict(shuffle=False, max_images=None, repeat=False, mirror_augment=False)),
    EasyDict(name='fid5k_full',     class_name='metrics.frechet_inception_distance.FID', max_reals=None, num_fakes=5000, minibatch_per_gpu=8, force_dataset_args=dict(shuffle=False, max_images=None, repeat=False, mirror_augment=False)),
    ...
    EasyDict(name='fid7k_full', class_name='metrics.frechet_inception_distance.FID', max_reals=None, num_fakes=7000, minibatch_per_gpu=8, force_dataset_args=dict(shuffle=False, max_images=None, repeat=False, mirror_augment=False)),
    EasyDict(name='fid14k_full', class_name='metrics.frechet_inception_distance.FID', max_reals=None, num_fakes=14000, minibatch_per_gpu=8, force_dataset_args=dict(shuffle=False, max_images=None, repeat=False, mirror_augment=False)),
